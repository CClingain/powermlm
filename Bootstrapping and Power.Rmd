...
## Single Power Estimate: Classroom data

The classroom dataset contains three nested levels: individuals within classrooms within schools. We will predict students' kindergarten math scores based on their socio-economic status, minority status, sex, and household poverty. A random slope at the school level will be included in the model. The power of the two fixed effects will be assessed. 

```{r}
power.class <- boot.power(model = mathkind ~ ses + minority + sex + housepov + (1|schoolid), n = 500, id = "childid", group1 = "schoolid", group2 = "classid", data = classroom)
power.class
```
